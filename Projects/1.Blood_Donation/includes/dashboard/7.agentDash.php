...
if (isset($_SESSION['id'])) {
    ...
    if (isset($_POST["doner_add"])) {
        ...
        $sql = "INSERT INTO doner (name ,blood_group ,p_address ,t_address ,age ,gender ,last_donated ,contact ,discription) VALUES(?,?,?,?,?,?,?,?,?);";
        ...
        {
            mysqli_stmt_bind_param($statement,"sssssssss",$name ,$blood_group ,$p_address ,$t_address ,$age ,$gender ,$last_donated ,$contact ,$discription );
            mysqli_stmt_execute($statement);
            header("Location:7.agentDash.php?Signup=Success");
            exit();
        }
    }
